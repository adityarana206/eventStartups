        ...
        <div className="privecy-policy-div-one">
          <div className="about-us-text-div">
            ...
            <span className="about-us-discription">
              ...
              returns. The following terms are applicable for any products that
          ...
          <div className="about-us-text-div">
            ...
            <ol className="privecy-policy-list">
              <li className="about-us-discription">
                ...
                “Our” in this Agreement) refers to DOTFYI Media Ventures Private
                Limited, 1553-A-8 Gali No.2, West Rohtash Nagar, Shahdara, East
                Delhi, India 110032.
              </li>
              <li className="about-us-discription">
              ...
              <li className="about-us-discription">
                Website refers to StartupNews.fyi, accessible
                from https://www.StartupNews.fyi​
              </li>
            </ol>
            <span className="about-us-discription">
          ...
          <div className="about-us-text-div">
            ...
            <div className="privecy-text-div">
              ...
              <span className="about-us-discription">
                ...
                your decision by means of a clear statement. You can inform us
                of your decision by:
              </span>
              <ol className="privecy-policy-list">
                <li className="about-us-discription">
                  By email: office@startupnews.fyi
                </li>
              </ol>
              <span className="about-us-discription">
            ...
            <div className="privecy-text-div">
              ...
              <ol className="privecy-policy-list">
                ...
                <li className="about-us-discription">
                  ...
                  suitable to be returned, deteriorates rapidly or where the
          ...
          <div className="about-us-text-div">
            ...
            <div className="privecy-text-div">
              ...
              <span className="about-us-discription">
                1553-A-8 Gali No.2, West Rohtash Nagar, Shahdara, East Delhi,
                India 110032​
              </span>
              <span className="about-us-discription">
