        ...
        <div className="privecy-policy-div-one">
          <div className="about-us-text-div">
            ...
            <span className="about-us-discription">
              In less than 15 months StartupNews.fyi spreaded it wings to over
              14 countries through our Media Partnership approach with some of
              the top event IP’s and top exhibitors from across the globe.
            </span>
          </div>
          <div className="about-us-text-div">
            ...
            <div className="privecy-text-div">
              ...
              <div className="partner-image">
                <img
                  src={InternationalPartnerImage}
                  alt="InternationalPartnerImage"
                />
              </div>
            </div>
          </div>
