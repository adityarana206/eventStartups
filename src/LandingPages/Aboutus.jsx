...
function Aboutus({ eventData, setSelectedLocation, isPopupOpen, setIsPopupOpen }) {
                ...
                <div className='about-us-div-one' >
                    ...
                    <div className='about-us-details-div' >
                        <div className='about-us-sub-detail' >
                            <div className='about-us-detail-div'>
                                <h2 className='about-us-details-heading' >Send your press release to</h2>
                                <span className='about-us-details-emails' >pressrelease@startupnews.fyi</span>
                            </div>
                            <div className='about-us-detail-div'>
                                <h2 className='about-us-details-heading' >For advertising and promotion</h2>
                                <span className='about-us-details-emails' >promotions@startupnews.fyi</span>
                            </div>
                            <div className='about-us-detail-div'>
                                <h2 className='about-us-details-heading' >Do give us feedback at</h2>
                                <span className='about-us-details-emails' >feedback@startupnews.fyi</span>
                            </div>
                        </div>
                        <div className='about-us-sub-detail'>
                            <div className='about-us-detail-div'>
                                <h2 className='about-us-details-heading' >For Events and Partnerships</h2>
                                <span className='about-us-details-emails' >events@startupnews.fyi</span>
                            </div>
                            <div className='about-us-detail-div'>
                                <h2 className='about-us-details-heading' >To work for us write to</h2>
                                <span className='about-us-details-emails' >jobs@startupnews.fyi</span>
                            </div>
                            <div className='about-us-detail-div'>
                                <h2 className='about-us-details-heading' >News Alert / Fake News alert</h2>
                                <span className='about-us-details-emails' >https://wa.me/919205412305</span>
                            </div>
                        </div>
                    </div>
                    <div className='about-us-icon'>
                        <div className='about-us-icons'>
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images'>
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219857/Vector_xysijx.png'} alt="" />
                                </div>
                            ...
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images'>
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219858/Vector_1_jmxt6y.png'} alt="" />
                                </div>
                                <div className='about-us-icon-texts'>
                            ...
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images' id='about-us-icon-strach'>
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219857/Group_fhb6xo.png'} alt="" />
                                </div>
                                <div className='about-us-icon-texts'>
                            ...
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images' id='about-us-icon-strach' >
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219857/Vector_2_jaaw2p.png'} alt="" />
                                </div>
                                <div className='about-us-icon-texts'>
                        ...
                        <div className='about-us-icons'>
                            ...
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images'>
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219857/Vector_3_ilkc80.png'} alt="" />
                                </div>
                                <div className='about-us-icon-texts'>
                            ...
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images'>
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219857/Group_633126_qsacko.png'} alt="" />
                                </div>
                                <div className='about-us-icon-texts'>
                                    <h2 className='about-us-value'>7</h2>
                                    <span className='about-us-text' >International Delegations</span>
                                </div>
                            </div>
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images'>
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219857/Vector_4_mndco8.png'} alt="" />
                                </div>
                                <div className='about-us-icon-texts'>
                        ...
                        <div className='about-us-icons'>
                            ...
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images'>
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219857/Group_1_fdbcws.png'} alt="" />
                                </div>
                                <div className='about-us-icon-texts'>
                            ...
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images'>
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219857/Group_2_nqfrct.png'} alt="" />
                                </div>
                                <div className='about-us-icon-texts'>
                            ...
                            <div className='about-us-icon-div' >
                                <div className='about-icon-images'>
                                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726219858/Vector_5_ine8nm.png'} alt="" />
                                </div>
                                <div className='about-us-icon-texts'>
                                    <h2 className='about-us-value'>1M +</h2>
                                    <span className='about-us-text' >Monthly Website Impressions</span>
                                </div>
                            </div>
                        </div>
                    </div>
