        ...
        <div className="privecy-policy-div-one">
          <div className="about-us-text-div">
            ...
            <span className="about-us-discription">
              Welcome to StartupNews.fyi!
            </span>
            <span className="about-us-discription">
              These terms and conditions outline the rules and regulations for
              the use of DOTFYI Media Ventures Private Limited’s Website,
              located at Website.com.
            </span>
            <span className="about-us-discription">
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use StartupNews.fyi if you do not
          ...
          <div className="about-us-text-div">
            ...
            <span className="about-us-discription">
              We employ the use of cookies. By accessing StartupNews.fyi, you
              agreed to use cookies in agreement with DOTFYI Media Ventures
          ...
          <div className="about-us-text-div">
            ...
            <div className="privecy-text-div">
              <span className="about-us-discription">
                Unless otherwise stated, DOTFYI Media Ventures Private Limited
                and/or its licensors own the intellectual property rights for
                all material on StartupNews.fyi. All intellectual property
                rights are reserved. You may access this from StartupNews.fyi
                for your personal use subject to restrictions set in these terms
                and conditions.
              </span>
              <span className="about-us-discription">You must not:</span>
              <ol className="privecy-policy-list">
                <li className="about-us-discription">
                  Republish material from StartupNews.fyi
                </li>
                <li className="about-us-discription">
                  Sell, rent or sub-license material from StartupNews.fyi
                </li>
                <li className="about-us-discription">
                  Reproduce, duplicate or copy material from StartupNews.fyi
                </li>
                <li className="about-us-discription">
                  Redistribute content from StartupNews.fyi​
                </li>
              </ol>
              <span className="about-us-discription">
              ...
              <span className="about-us-discription">
                ...
                website. DOTFYI Media Ventures Private Limited does not filter,
                edit, publish or review Comments before their presence on the
                website. Comments do not reflect the views and opinions of
                DOTFYI Media Ventures Private Limited, its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who posts their views and opinions. To the extent
                permitted by applicable laws, DOTFYI Media Ventures Private
                Limited shall not be liable for the Comments or any liability,
              ...
              <span className="about-us-discription">
                DOTFYI Media Ventures Private Limited reserves the right to
              ...
              <span className="about-us-discription">
                You hereby grant DOTFYI Media Ventures Private Limited a
          ...
          <div className="about-us-text-div">
            ...
            <div className="privecy-text-div">
              ...
              <span className="about-us-discription">
                ...
                of DOTFYI Media Ventures Private Limited; and (d) the link is in
              ...
              <span className="about-us-discription">
                ...
                by sending an e-mail to DOTFYI Media Ventures Private Limited.
              ...
              <span className="about-us-discription">
                No use of DOTFYI Media Ventures Private Limited’s logo or other
          ...
          <div className="about-us-text-div">
            ...
            <div className="privecy-text-div">
              <span className="about-us-discription">
                ...
                the advertising partners of StartupNews.fyi.​
              </span>
              <span className="about-us-discription">
                IThird-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on
                StartupNews.fyi, which are sent directly to users’ browser. They
              ...
              <span className="about-us-discription">
                Note that StartupNews.fyi has no access to or control over these
