...
const SearchResults = ({ newsItems, eventData }) => {
    ...
    const filterNews = (newsItems, query) => {
        ...
        newsItems.forEach(item => {
            ...
            if (item.activity && Array.isArray(item.rssContent)) {
                item.rssContent.forEach(news => {
                    ...
                    const titleMatches = eventWords && eventWords.includes(lowerCaseQuery);
                    const industryMatches = item.industry.toLowerCase().includes(lowerCaseQuery);
        ...
        filteredNews.sort((a, b) => new Date(b.newsDetails.publishDate) - new Date(a.newsDetails.publishDate));
        ...
        <div className='search-container'>
            ...
            {error && (
                <div className="error-container">
                    <img src={'https://res.cloudinary.com/dffy79nhw/image/upload/v1726074687/Page_not_found_new_tizdys.png'} alt="No results found" className="page-not-found" />
                </div>
            )}
            {(<div className='spcific-industry-container'>
                {filteredResults.slice(0, 4).length > 0 && <div className='latest-news-container'>
                    {filteredResults.slice(0, 4).length > 0 && <div className='industry-news-details'>
                        <div className='latest-news-heading'>
                            <h2 className='latest-news-text'>Latest News</h2>
                        </div>
                        <div className='latest-news-cards'>
                            {filteredResults && filteredResults.length > 0 ? (
                                filteredResults.slice(0, 4).map((newws, index) => (
                                    <NewsCardThree key={index} news={newws} allNewsData={filteredResults} />
                                ))
                            ) : (
                    ...
                    {eventData.slice(0, 5).length > 0 && <div className='industry-events'>
                ...
                {filteredResults.slice(4, 8).length > 0 && <div className='latest-news-container'>
                    <div className='latest-news-details'>
                        ...
                        <div className='latest-news-cards'>
                            {filteredResults && filteredResults.length > 0 ? (
                                filteredResults.slice(4, 8).map((newws, index) => (
                                    <NewsCardThree key={index} news={newws} allNewsData={filteredResults} />
                                ))
                            ) : (
                                <p>No News To Display</p>
                ...
                {filteredResults.slice(8, 12).length > 0 && <div className='latest-news-container'>
                    {filteredResults.slice(8, 12).length > 0 && <div className='industry-news-details'>
                        <div className='latest-news-heading'>
                            <h2 className='latest-news-text'>Latest News</h2>
                        </div>
                        <div className='latest-news-cards'>
                            {filteredResults && filteredResults.length > 0 ? (
                                filteredResults.slice(8, 12).map((newws, index) => (
                                    <NewsCardThree key={index} news={newws} allNewsData={filteredResults} />
                                ))
                            ) : (
                                <p>No News To Display</p>
                    ...
                    {eventData.slice(5, 10).length > 0 && <div className='industry-events'>
                        <h2 className='upcoming-event-text'>Upcoming Events</h2>
                        <div className='upcoming-event-cards'>
                ...
                {filteredResults.slice(12, 16).length > 0 && <div className='latest-news-container'>
                    {filteredResults.slice(12, 16).length > 0 && <div className='industry-news-details'>
                        <div className='latest-news-heading'>
                            <h2 className='latest-news-text'>Latest News</h2>
                        </div>
                        <div className='latest-news-cards'>
                            {filteredResults && filteredResults.length > 0 ? (
                                filteredResults.slice(12, 16).map((newws, index) => (
                                    <NewsCardThree key={index} news={newws} allNewsData={filteredResults} />
                                ))
                            ) : (
                                <p>No News To Display</p>
                    ...
                    {eventData.slice(10, 15).length > 0 && <div className='industry-events'>
                        <h2 className='upcoming-event-text'>Upcoming Events</h2>
                        <div className='upcoming-event-cards'>
                ...
                {filteredResults.slice(16, 20).length > 0 && <div className='latest-news-container'>
                    {filteredResults.slice(16, 20).length > 0 && <div className='industry-news-details'>
                        <div className='latest-news-heading'>
                            <h2 className='latest-news-text'>Latest News</h2>
                        </div>
                        <div className='latest-news-cards'>
                            {filteredResults && filteredResults.length > 0 ? (
                                filteredResults.slice(16, 20).map((newws, index) => (
                                    <NewsCardThree key={index} news={newws} allNewsData={filteredResults} />
                                ))
                            ) : (
                                <p>No News To Display</p>
                    ...
                    {eventData.slice(15, 20).length > 0 && <div className='industry-events'>
                        <h2 className='upcoming-event-text'>Upcoming Events</h2>
                        <div className='upcoming-event-cards'>
                ...
                {filteredResults.slice(20, 24).length > 0 && <div className='latest-news-container'>
                    {filteredResults.slice(20, 24).length > 0 && <div className='industry-news-details'>
                        <div className='latest-news-heading'>
                            <h2 className='latest-news-text'>Latest News</h2>
                        </div>
                        <div className='latest-news-cards'>
                            {filteredResults && filteredResults.length > 0 ? (
                                filteredResults.slice(20, 24).map((newws, index) => (
                                    <NewsCardThree key={index} news={newws} allNewsData={filteredResults} />
                                ))
                            ) : (
                                <p>No News To Display</p>
                    ...
                    {eventData.slice(25, 30).length > 0 && <div className='industry-events'>
                        <h2 className='upcoming-event-text'>Upcoming Events</h2>
                        <div className='upcoming-event-cards'>
