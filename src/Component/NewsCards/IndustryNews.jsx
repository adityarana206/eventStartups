...
const IndustryNews = ({ newsItems, filteredEventData, selectedIndustry, eventData}) => {
    ...
    function SelectedIndustryNews(newsItems) {
        ...
        newsItems.forEach(item => {
            if (item.activity && Array.isArray(item.rssContent) && item.industry.toLowerCase() === selectedIndustry.toLowerCase()) {
        ...
        <div className='spcific-industry-container'>
            ...
            {nationalEvents.slice(0, 4).length > 0 && <div className='national-events'>
                <div className='national-events-details'>
                    <div className='latest-news-heading'>
                        <h2 className='latest-news-text'>{selectedIndustry} Events</h2>
            ...
            {news.slice(8, 12).length > 0 && <div className='national-events'>
                <div className='national-events-details'>
                    <div className='latest-news-heading'>
                        <h2 className='latest-news-text'>{selectedIndustry} Top News</h2>
                        {/* <Link className='latest-news-link'>View all</Link> */}
                    </div>
                    <div className='national-events-cards'>
