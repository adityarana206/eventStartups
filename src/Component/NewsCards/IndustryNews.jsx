...
import NewsCardOne from "./AllNewsCards/NewsCardOne";
import NewsCardTwo from "./AllNewsCards/NewsCardTwo";
...
import animationData from "../../Assets/AllNews/pagenotfound.json";
...
const IndustryNews = ({
  ...
  const actualIndustry = selectedIndustry || industry || "";
  const resolvedFilteredEventData =
    filteredEventData ||
    (eventData || []).filter(
      (event) =>
        event.industry &&
        actualIndustry &&
        event.industry.toLowerCase() === actualIndustry.toLowerCase(),
    );
  ...
  function SelectedIndustryNews(newsItems) {
    if (!newsItems) return [];
    ...
    newsItems.forEach((item) => {
      if (
        item.activity &&
        Array.isArray(item.rssContent) &&
        item.industry &&
        actualIndustry &&
        item.industry.toLowerCase() === actualIndustry.toLowerCase()
      ) {
    ...
    if (ecommerceNews.length === 0) {
      setError(true); // Set error state if no news is found
    }

    return ecommerceNews;
  }

  useEffect(() => {
    const checkAndSetNews = () => {
      if (newsItems && newsItems.length > 0) {
        const filteredNews = SelectedIndustryNews(newsItems);
  ...
  // console.log(news, "industry news")
  return (
    <div className="spcific-industry-container">
      ...
      {/* National Events */}
      {nationalEvents.slice(0, 4).length > 0 && (
        <div className="national-events">
          <div className="national-events-details">
            <div className="latest-news-heading">
              <h2 className="latest-news-text">{actualIndustry} Events</h2>
      ...
      {news.slice(4, 8).length > 0 && (
        <div className="latest-news-container">
          ...
          <div className="company-details-container">
            ...
            <button className="company-button" onClick={handleReadMoreClick}>
              Join our Community
            </button>
          </div>
        </div>
      ...
      {/* Industry Top News */}
      {news.slice(8, 12).length > 0 && (
        <div className="national-events">
          <div className="national-events-details">
            <div className="latest-news-heading">
              <h2 className="latest-news-text">{actualIndustry} Top News</h2>
              {/* <Link className='latest-news-link'>View all</Link> */}
            </div>
            <div className="national-events-cards">
              {news ? (
      ...
      {loadCount >= 1 && (
        <>
          {nationalEvents.slice(4, 8).length > 0 && (
            <div className="national-events">
              <div className="national-events-details">
                <div className="latest-news-heading">
                  <h2 className="latest-news-text">{actualIndustry} Events</h2>
          ...
          {/* Industry Top News */}
          {news.slice(16, 20).length > 0 && (
            <div className="national-events">
              <div className="national-events-details">
                <div className="latest-news-heading">
                  <h2 className="latest-news-text">
                    {actualIndustry} Top News
                  </h2>
                  {/* <Link className='latest-news-link'>View all</Link> */}
                </div>
                <div className="national-events-cards">
      ...
      {loadCount >= 2 && (
        <>
          {nationalEvents.slice(8, 12).length > 0 && (
            <div className="national-events">
              <div className="national-events-details">
                <div className="latest-news-heading">
                  <h2 className="latest-news-text">{actualIndustry} Events</h2>
      ...
      {loadCount >= 3 && (
        <>
          {nationalEvents.slice(12, 16).length > 0 && (
            <div className="national-events">
              <div className="national-events-details">
                <div className="latest-news-heading">
                  <h2 className="latest-news-text">{actualIndustry} Events</h2>
