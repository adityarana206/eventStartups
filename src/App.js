...
function App() {
  ...
  useEffect(() => {
    const loadNewsData = async () => {
      // await fetchNewsData(); // Disabled to use mock data instantly on startup
    };
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/search"
            element={
              <SearchResults newsItems={newsItems} eventData={eventData} />
            }
          />
          ...
          <Route
            ...
            element={
              <NewsDetails eventData={eventData} newsItems={newsItems} />
            }
          />
          <Route
            path="/:industry"
            element={
              <IndustryNews newsItems={newsItems} eventData={eventData} />
            }
          />
